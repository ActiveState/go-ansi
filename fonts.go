...
// font contains binary font data, size info, etc.
type font struct {
	data        []byte
	sizeX       int
	sizeY       int
...
// AlSelectFont provides choose a font and populates font with that font
func alSelectFont(f *font, fontName string) {
	// determine the font we use to render the output
	if fontName == "80x25" {
		f.data = fontPC80x25
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "80x50" {
		f.data = fontPC80x50
		f.sizeX = 9
		f.sizeY = 8
	} else if fontName == "terminus" {
		f.data = fontPCTerminus
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "baltic" {
		f.data = fontPCBaltic
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "cyrillic" {
		f.data = fontPCCyrillic
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "french-canadian" {
		f.data = fontPCFrenchCanadian
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "greek" {
		f.data = fontPCGreek
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "greek-869" {
		f.data = fontPCGreek869
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "hebrew" {
		f.data = fontPCHebrew
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "icelandic" {
		f.data = fontPCIcelandic
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "latin1" {
		f.data = fontPCLatin1
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "latin2" {
		f.data = fontPCLatin2
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "nordic" {
		f.data = fontPCNordic
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "portuguese" {
		f.data = fontPCPortuguese
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "russian" {
		f.data = fontPCRussian
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "turkish" {
		f.data = fontPCTurkish
		f.sizeX = 9
		f.sizeY = 16
	} else if fontName == "amiga" {
		f.isAmigaFont = true
		f.data = fontAmigaTopaz1200
		f.sizeX = 8
		f.sizeY = 16
	} else if fontName == "microknight" {
		f.isAmigaFont = true
		f.data = fontAmigaMicroknight
		f.sizeX = 8
		f.sizeY = 16
	} else if fontName == "microknight+" {
		f.isAmigaFont = true
		f.data = fontAmigaMicroknightPlus
		f.sizeX = 8
		f.sizeY = 16
	} else if fontName == "mosoul" {
		f.isAmigaFont = true
		f.data = fontAmigaMosoul
		f.sizeX = 8
		f.sizeY = 16
	} else if fontName == "pot-noodle" {
		f.isAmigaFont = true
		f.data = fontAmigaPotNoodle
		f.sizeX = 8
		f.sizeY = 16
	} else if fontName == "topaz" {
		f.isAmigaFont = true
		f.data = fontAmigaTopaz1200
		f.sizeX = 8
		f.sizeY = 16
		...
		f.isAmigaFont = true
		f.data = fontAmigaTopaz1200Plus
		f.sizeX = 8
		f.sizeY = 16
	} else if fontName == "topaz500" {
		f.isAmigaFont = true
		f.data = fontAmigaTopaz500
		f.sizeX = 8
		f.sizeY = 16
	} else if fontName == "topaz500+" {
		f.isAmigaFont = true
		f.data = fontAmigaTopaz500Plus
		f.sizeX = 8
		f.sizeY = 16
	} else {
...
var fontAmigaMicroknightPlus = []byte{
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
var fontAmigaTopaz1200Plus = []byte{
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x83, 0x83, 0x39, 0x39, 0x21, 0x21, 0x29, 0x29, 0x21, 0x21, 0x3f, 0x3f, 0x87, 0x87, 0xff, 0xff,
	0xc3, 0xc3, 0x99, 0x99, 0x99, 0x99, 0x81, 0x81, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0xff, 0xff,
	0x83, 0x83, 0x99, 0x99, 0x99, 0x99, 0x83, 0x83, 0x99, 0x99, 0x99, 0x99, 0x83, 0x83, 0xff, 0xff,
...
var fontAmigaTopaz500Plus = []byte{
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
